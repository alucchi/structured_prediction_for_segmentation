...
# define SVM_POLY    1           /* polynomial kernel type */
# define SVM_RBF     2           /* rbf kernel type */
# define SVM_SIGMOID 3           /* sigmoid kernel type */
# define SVM_CUSTOM  4           /* userdefined kernel function from kernel.h */
# define SVM_GRAM    5           /* use explicit gram matrix from kernel_parm */
...
SVECTOR *create_svector(SWORD *, char *, double);
